# TICKET-4: Registry fixtures incomplete — missing fresh-own and malformed variants

## Evidence

The seed's endpoint-contention spec (SEED.md, launch-setup.sh goal text) defines four registry states:
